package com.jykj.materiel.config.logConfig;
...
import com.jykj.materiel.util.IpUtiles;
import com.jykj.materiel.util.JsonUtiles;
...
public class SystemLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(SystemLogService)")
    public void serviceAspect(){
    }

    //Controller层切点
    @Pointcut("@annotation(SystemLogController)")
...
//            System.out.println("请求时间 create_date："+df.format(new Date()));
            ...
            sysLog.setIp(ip);//ip
            sysLog.setCreateDate(new Date());//请求时间 df.format(new Date())
